...
const targetPath = 'c:\\\\Users\\\\4thge\\\\Desktop\\\\dgtools\\\\velotime-landing\\\\src\\\\content\\\\glossary.js';
const workspaceCopy = path.join(__dirname, '..', 'src', 'content', 'glossary.js');
...
const expandedTerms = [
  {
    ...
    formulaComponents: [
      { name: 'Total Billable Hours', description: 'Actual hours logged directly to client deliverables and invoiced contracts.' },
      { name: 'Total Available Capacity Hours', description: 'Total contracted working hours minus approved holidays and paid time off (PTO).' }
    ],
    example: {
    ...
    relatedTerms: ['blended-rate', 'scope-creep', 'capacity-planning']
  },
  {
    slug: 'scope-creep',
    ...
    formulaComponents: [
      { name: 'Actual Hours Incurred', description: 'Total engineering, design, and management hours spent across the entire project lifecycle.' },
      { name: 'Original Budgeted Scoped Hours', description: 'The baseline hours estimated and agreed upon in the signed contract or Statement of Work.' }
    ],
    example: {
    ...
    relatedTerms: ['retainer', 'value-based-pricing', 'over-servicing']
  },
  {
    slug: 'blended-rate',
    ...
    formulaComponents: [
      { name: 'Total Invoiced Labor Fees', description: 'Total dollar amount billed to the client for services rendered.' },
      { name: 'Total Project Hours Worked', description: 'Sum of all hours logged across senior engineers, junior developers, designers, and project managers.' }
    ],
    example: {
    ...
    relatedTerms: ['billable-utilization', 'value-based-pricing', 'cost-rate']
  },
  {
    slug: 'retainer',
    category: 'Pricing & Billing',
    ...
    formulaComponents: [
      { name: 'Monthly Retainer Fee', description: 'The fixed recurring fee billed and collected at the beginning of each billing cycle.' },
      { name: 'Agreed Hourly Billing Rate', description: 'The baseline hourly rate used to calculate monthly capacity allocation and overage charges.' }
    ],
    example: {
    ...
    relatedTerms: ['scope-creep', 'billable-utilization', 'burn-rate']
  },
  {
    ...
    formulaComponents: [
      { name: 'Quantified Client Economic Value', description: 'The measurable revenue upside, cost reduction, or risk mitigation generated by the agency\'s solution.' },
      { name: 'Value Capture Percentage', description: 'The percentage of that value the agency captures as its fee (typically 10% to 20% for high-conviction consultancies).' }
    ],
    example: {
    ...
    relatedTerms: ['blended-rate', 'scope-creep', 'fixed-fee-project']
  },
  {
    ...
    formulaComponents: [
      { name: 'Total Invoiced Revenue', description: 'Actual dollars collected from the client for hours worked.' },
      { name: 'Total Billable Value at Standard Rate', description: 'Sum of all logged hours multiplied by standard rack card billing rates.' }
    ],
    example: {
    ...
    relatedTerms: ['billable-utilization', 'scope-creep', 'effective-hourly-rate']
  },
  {
    slug: 'burn-rate',
    category: 'Profitability & Margins',
    ...
    formulaComponents: [
      { name: '% of Budgeted Hours Consumed', description: '(Hours Logged to Date / Total Contract Budget Hours) × 100' },
      { name: '% of Calendar Timeline Elapsed', description: '(Days Elapsed in Billing Period / Total Days in Period) × 100' }
    ],
    example: {
    ...
    relatedTerms: ['retainer', 'scope-creep', 'project-overrun']
  },
  {
    ...
    formulaComponents: [
      { name: 'Fixed Contract Price', description: 'The total agreed contractual revenue milestone.' },
      { name: 'Actual Hours Worked', description: 'Total hours logged across all team members to deliver the agreed scope.' },
      { name: 'Direct Loaded Hourly Cost', description: 'Internal fully loaded cost per hour of assigned team members.' }
    ],
    example: {
    ...
    relatedTerms: ['value-based-pricing', 'scope-creep', 'time-and-materials']
  },
  {
    ...
    formulaComponents: [
      { name: 'Billable Hours Worked', description: 'Verifiable hours logged by developers, designers, and consultants.' },
      { name: 'Hourly Billing Rate', description: 'Contracted rate per role or blended hourly rate.' },
      { name: 'Approved Direct Expenses', description: 'Reimbursable pass-through costs (e.g. cloud hosting, specialized APIs, stock assets).' }
    ],
    example: {
    ...
    relatedTerms: ['fixed-fee-project', 'retainer', 'cost-rate']
  },
  {
    slug: 'over-servicing',
    category: 'Operations & Risk',
    ...
    formulaComponents: [
      { name: 'Actual Hours Invested', description: 'Total hours logged to the project or account across all disciplines.' },
      { name: 'Billed Hours', description: 'The contracted or invoiced hours paid for by the client.' },
      { name: 'Standard Billing Rate', description: 'The agency\'s standard hourly billing rate for the services rendered.' }
    ],
    example: {
    ...
    relatedTerms: ['scope-creep', 'burn-rate', 'realization-rate']
  },
  {
    ...
    formulaComponents: [
      { name: 'Total Net Revenue Collected', description: 'Actual cash revenue received from the client (excluding pass-through expenses and software fees).' },
      { name: 'Total Actual Hours Worked', description: 'Sum of all hours invested across all roles (including unbilled revisions and project management).' }
    ],
    example: {
    ...
    relatedTerms: ['blended-rate', 'value-based-pricing', 'burn-rate']
  },
  {
    ...
    formulaComponents: [
      { name: 'Total Available Billable Hours', description: 'Gross team hours minus holidays, approved PTO, and target non-billable buffer.' },
      { name: 'Total Committed Project Hours', description: 'Sum of active client retainer allocations, sprint backlogs, and booked fixed-fee milestones.' }
    ],
    example: {
    ...
    relatedTerms: ['billable-utilization', 'over-servicing', 'burn-rate']
  },
  {
    ...
    formulaComponents: [
      { name: 'Total Logged Working Hours', description: 'All hours spent working on company payroll.' },
      { name: 'Total Invoiced Billable Hours', description: 'Hours directly allocated to client deliverables and billed on invoices.' }
    ],
    example: {
    ...
    relatedTerms: ['billable-utilization', 'realization-rate', 'bench-cost']
  },
  {
    slug: 'cost-rate',
    category: 'Profitability & Margins',
    ...
    formulaComponents: [
      { name: 'Annual Base Salary', description: 'Direct gross payroll compensation.' },
      { name: 'Taxes & Benefits', description: 'Employer payroll taxes, health insurance, 401(k) matching, and bonuses (typically 20%–25% of salary).' },
      { name: 'Allocated Overhead', description: 'Per-employee share of software licenses, office rent, insurance, and administrative payroll.' },
      { name: 'Annual Available Hours', description: 'Total working hours per year (typically 1,840 to 1,920 hours after PTO and holidays).' }
    ],
    example: {
    ...
    relatedTerms: ['blended-rate', 'billable-utilization', 'realization-rate']
  },
  {
    ...
    formulaComponents: [
      { name: 'Total Annual Agency Net Revenue', description: 'Gross revenue minus pass-through expenses and direct third-party contractor payouts.' },
      { name: 'Total FTE Headcount', description: 'Total full-time employees plus normalized part-time contractor equivalents across all departments.' }
    ],
    example: {
    ...
    relatedTerms: ['billable-utilization', 'effective-hourly-rate']
  },
  {
    ...
    formulaComponents: [
      { name: 'Unbilled Billable Hours', description: 'Verified timesheet hours logged to active projects that are not yet attached to an issued invoice.' },
      { name: 'Assigned Billing Rate', description: 'Applicable hourly contract rate for the project or role.' },
      { name: 'Unbilled Reimbursable Expenses', description: 'Out-of-pocket project costs (software, assets, cloud staging) awaiting client billing.' }
    ],
    example: {
    ...
    relatedTerms: ['time-and-materials', 'realization-rate', 'days-sales-outstanding']
  },
  {
    ...
    formulaComponents: [
      { name: 'Expected Annual Billable Hours', description: 'The budgeted billable quota required to achieve target gross labor margins.' },
      { name: 'Total Available Working Hours', description: 'Gross contracted hours (e.g. 2,080) minus approved PTO and statutory holidays (typically 1,840 to 1,920 net hours).' }
    ],
    example: {
  ...
  },
  {
    ...
    formulaComponents: [
      { name: 'Logged Timesheet Hours', description: 'Hours recorded on client invoices and payroll reports.' },
      { name: 'True Active Production Hours', description: 'Actual focused time spent executing project deliverables.' }
    ],
    example: {
    ...
    relatedTerms: ['billable-utilization', 'realization-rate']
  },
  {
    ...
    formulaComponents: [
      { name: 'Actual Total Project Cost', description: 'Total direct labor costs + expenses incurred across the entire project lifecycle.' },
      { name: 'Budgeted Project Cost', description: 'The baseline cost modeled during proposal estimation and scoping.' }
    ],
    example: {
    ...
    relatedTerms: ['fixed-fee-project', 'scope-creep', 'burn-rate']
  },
  {
    ...
    formulaComponents: [
      { name: 'Total Estimated Direct Labor Cost', description: 'Projected hours multiplied by team loaded hourly cost rates.' },
      { name: 'Target Markup %', description: 'Desired gross margin multiplier (e.g. 50% to 100%+ markup).' }
    ],
    example: {
    ...
    relatedTerms: ['value-based-pricing', 'time-and-materials', 'cost-rate']
  },
  {
    ...
    formulaComponents: [
      { name: 'Total Indirect Operating Expenses', description: 'All non-billable overhead: executive salaries, sales/marketing, office rent, software licenses, legal, and insurance.' },
      { name: 'Total Direct Billable Labor Payroll', description: 'Total wages and loaded compensation paid to billable production engineers and designers.' }
    ],
    example: {
  ...
  },
  {
    ...
    formulaComponents: [
      { name: 'Idle Unassigned Hours', description: 'Available working hours where a billable team member has zero active client or billable project allocation.' },
      { name: 'Individual Loaded Hourly Cost Rate', description: 'The fully loaded hourly cost of employing that individual (salary + taxes + benefits + overhead share).' }
    ],
    example: {
  ...
  },
  {
    ...
    formulaComponents: [
      { name: 'Annual Fully Loaded Employee Cost', description: 'Base salary + payroll taxes + healthcare/benefits + allocated share of agency overhead.' },
      { name: 'Annual Available Hours', description: 'Gross annual hours minus PTO and holidays (typically 1,840 to 1,920 hours).' },
      { name: 'Target Utilization Rate', description: 'The expected billable utilization percentage for the role (e.g. 75% for mid-level developers).' }
    ],
    example: {
  ...
  },
  {
    ...
    formulaComponents: [
      { name: 'Total Accounts Receivable', description: 'The total unpaid balance of all sent client invoices currently outstanding.' },
      { name: 'Total Credit Sales in Period', description: 'Total invoiced revenue generated during the measured time frame (typically quarterly or annually).' },
      { name: 'Number of Days in Period', description: 'The calendar days in the measurement window (e.g. 90 days for quarterly DSO, 365 for annual).' }
    ],
    example: {
...
const fileContent = `export const glossaryTerms = ${JSON.stringify(expandedTerms, null, 2)};
...
console.log('✅ Generated expanded glossary data in ' + targetPath);
